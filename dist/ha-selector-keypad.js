 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */var n$1;const e$2=null!=(null===(n$1=window.HTMLSlotElement)||void 0===n$1?void 0:n$1.prototype.assignedElements)?(o,n)=>o.assignedElements(n):(o,n)=>o.assignedNodes(n).filter((o=>o.nodeType===Node.ELEMENT_NODE));function l$1(n){const{slot:l,selector:t}=null!=n?n:{};return o$1({descriptor:o=>({get(){var o;const r="slot"+(l?`[name=${l}]`:":not([name])"),i=null===(o=this.renderRoot)||void 0===o?void 0:o.querySelector(r),s=null!=i?e$2(i,n):[];return t?s.filter((o=>o.matches(t))):s},enumerable:!0,configurable:!0})})}
...
console.info(`%c  HA-KEYPAD-SELECTOR  \n%c Version ${version} `, 'color: white; font-weight: bold; background: rgb(137, 179, 248)', 'color: black; font-weight: bold; background: rgb(245, 245, 245)');
const DEFAULTS = {
    show_code: true,
    show_label: true,
    columns: 3,
...
let HaKeypadSelector = class HaKeypadSelector extends s$1 {
    constructor() {
        super();
    ...
    get showLabel() {
        var _a, _b;
        return (_b = (_a = this.selector.keypad) === null || _a === void 0 ? void 0 : _a.show_label) !== null && _b !== void 0 ? _b : DEFAULTS.show_label;
    }
    get showCode() {
        var _a, _b;
        return (_b = (_a = this.selector.keypad) === null || _a === void 0 ? void 0 : _a.show_code) !== null && _b !== void 0 ? _b : DEFAULTS.show_code;
    }
    get columnCount() {
        var _a, _b;
        return (_b = (_a = this.selector.keypad) === null || _a === void 0 ? void 0 : _a.columns) !== null && _b !== void 0 ? _b : DEFAULTS.columns;
    }
    get keys() {
        var keyList = lodashExports.rangeRight(10).map(x => x.toString());
    ...
    get formattedCode() {
        var _a, _b;
        var toReturn;
        if ((_a = this.selector.keypad) === null || _a === void 0 ? void 0 : _a.mask) {
            toReturn = (_b = this.selector.keypad) === null || _b === void 0 ? void 0 : _b.mask.repeat(this._tokens.length);
        }
        else {
    ...
    renderKey(key) {
        var keyContent;
        var keyStyle = `width: calc((100% * (1/${this.columnCount})) - (2 * var(--hakp-key-padding)));`;
        if (key == DELETE_KEY) {
            keyContent = x `<ha-icon icon="mdi:backspace-outline"></ha-icon>`;
        }
        else if (key == CLEAR_KEY) {
            keyContent = x `<ha-icon icon="mdi:close-circle-outline"></ha-icon>`;
        }
        else {
            keyContent = x `${key}`;
        }
    ...
    onKeyPressed(token) {
        ...
        if (isUpdateRequired == true) {
            this.requestUpdate();
            ne(this, "value-changed", { value: this.rawCode });
        }
    }
    render() {
        return x `
            <div class="hakp-container">
                <div class="hakp-code">
                    ${this.showLabel ? x `<div class="hakp-code-label">${this.label}</div>` : A}
                    ${this.showCode ? x `<div class="hakp-code-value">${this.formattedCode}</div>` : A}
                </div>
...
__decorate([
    n$2()
], HaKeypadSelector.prototype, "hass", void 0);
__decorate([
    n$2()
], HaKeypadSelector.prototype, "label", void 0);
__decorate([
    n$2()
], HaKeypadSelector.prototype, "selector", void 0);
HaKeypadSelector = __decorate([
    e$4("ha-selector-keypad")
], HaKeypadSelector);

export { HaKeypadSelector };
//# sourceMappingURL=ha-selector-keypad.js.map
